...
try:
    ...
    conn = oracledb.connect(user="rm92976", password="010304", dsn="oracle.fiap.com.br:1521/orcl")
...
while conexao:
    ...
    if escolha == 1:
        ...
        # Chama a procedure para inserir um novo Pet
        inst_cadastro.callproc('cadastrar_pet', [tipo, nome, idade])
    ...
    # LISTAR PETS POR ID
        ...
        # Chama a Função para Recuperar um Pet
        lista = inst_consulta.callfunc('recuperar_pet_por_id', str, [pet_id])
    ...
    # ALTERAR OS DADOS DE UM REGISTRO
        ...
        if len(lista_dados) == 0: # se não há o id
            ...
            nova_idade = int(input(margem + "Digite uma nova idade: "))

            # Chama a procedure para atualizar um novo Pet
            inst_alteracao.callproc('alterar_pet', [pet_id, novo_tipo, novo_nome, nova_idade])
    ...
    # EXCLUIR UM REGISTRO
        ...
        if pet_id.isdigit():
            ...
            if len(lista_dados) == 0:
                ...
                # Chama a procedure para deletar um pet pelo ID
                inst_exclusao.callproc('excluir_pet', [pet_id])
    ...
    # EXCLUIR TODOS OS REGISTROS
        ...
        if confirma.upper() == "S":
            ...
            inst_exclusao.callproc('excluir_todos_pets') ## A Procedure não recebe parâmetros
